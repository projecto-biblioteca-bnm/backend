...
import SidebarChefe from '../../components/layout/SidebarChefe';
...
export default function ChefeReparticaoDashboard() {
    ...
    const renderContent = () => {
        switch (activeKey) {
            ...
            case 'catalogo':
                return <Placeholder title="Visualizar Catálogo" />;
    ...
    return (
        <div className="flex flex-col min-h-screen bg-gray-50">
            <Topbar title="Sistema de Gestão da BNM - Chefe de Repartição" />
            <div className="flex flex-1">
                <SidebarChefe activeKey={activeKey} onSelect={handleSelect} />
